...
function chartjsLineChartForcast(
  selector,
  label = "",
  startGradient = "#D94F0012",
  endGradient = "#D94F0002",
  bColor = "#20C997",
          ...
          datasets: [
            {
              ...
              // backgroundColor: bgColor,
              borderColor: bColor,
              pointHoverBackgroundColor: "#D94F00",
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          {
            data: dataG,
            backgroundColor: "#D94F0080",
            hoverBackgroundColor: "#D94F00",
            label: "Gained",
          },
          {
            data: dataL,
...
chartJsBarChartThree("mychart8", "#D94F0020", "#D94F00", "Order");
chartJsBarChartThree("mychart9", "#D94F0020", "#D94F00", "Revenue");
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          {
            data: data,
            backgroundColor: ["#20C997", "#D94F00", "#FA8B0C"],
            total: "9,283",
          },
        ],
      },
